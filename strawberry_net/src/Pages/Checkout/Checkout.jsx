...
export function Checkout() {
  ...
  let orderid = uuid().toString().replace("-", "").substring(0, 8);
  // console.log(orderid);
  let total = 0;
  cart &&
    cart.length > 0 &&
                    ...
                    <div className={styles.bagData}>
                      <div className={styles.notifications}>
                        ...
                        <ul>
                          ...
                          <li>
                            Due to current situation, a 3.5% freight surcharge
                            will be applied to your order
                          </li>
                          <li>
                            Please note that delivery to your selected region
                            will be delayed because order dispatches are on hold
                            due to shipping restrictions. For more information,
                            please contact info@strawberrynet.com.
                          </li>
                          <li>
                            This order may be subject to duties and taxes, which
                            are payable by the customer and are not refundable.
                          </li>
                          <li>
                          ...
                          return (
                            <div className={styles.prodbag}>
                              ...
                              <div style={{ width: "45%" }}>
                                ...
                                <div>
                                  {Number(parseInt(el.size[0].price.replace))}
                                </div>
                              </div>
                              <div>Qty. {el.qty}</div>
                              <div style={{ marginLeft: "10%" }}>
                                {Number(parseInt(el.size[0].price)) *
                                  Number(el.qty)}
                              </div>
                              <br />
              ...
              {cart && cart.length > 0 && (
                <div className={styles.checksignout}>
                  <div className={styles.checkoutbag}>
                    ...
                    <button
                      onClick={handlePromo}
                      className={styles.checkoutbagbtn}
                    >
                      APPLY
                    </button>
                    {promCode && (
                      <p style={{ color: "hotpink", marginTop: "10px" }}>
