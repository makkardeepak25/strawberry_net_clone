              ...
              {cart && cart.length > 0 ? (
                <>
                  ...
                  <div className={styles.bagData}>
                    <p>
                      Spend INR2,554.30 more for a reduced standard shipping fee
                      at INR379.​
                    </p>
                    <div className={styles.shipBar}>
                      <div
                        className={styles.shipAmt}
                        style={{ width: "44%" }}
                      />
                    </div>
                    <p>
                      INR758.00 delivery fee for order below INR7,579.90.​ Free
                      standard shipping for order above INR11,369.80.
                    </p>
                    <p style={{ marginTop: "25px" }}>
                      Goods shipped from Strawberrynet
                    </p>
                          ...
                          cart.map((el) => {
                            return (
                              <div className={styles.prodbag}>
                                ...
                                <br />
                                <div
                                  onClick={() => removeFromBag(el._id)}
                                  className={styles.removeprod}
                                >
                                  <CloseIcon />
                                </div>
                ...
                <div className={styles.emptybag}>
                  <div className={styles.addprods}>
                    Bag is Empty! Add some Products
                  </div>
                  <Link to={"/"}>
            ...
            <div className={styles.checksignout}>
              <div className={styles.checkoutbag}>
                ...
                <Link to={"/user/checkout"}>
                  {" "}
                  <button className={styles.checkoutbagbtn}>
                    Check Out
                  </button>{" "}
                </Link>
              </div>
