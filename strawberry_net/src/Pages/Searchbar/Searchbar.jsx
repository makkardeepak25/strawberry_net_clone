  ...
  return (
    <div className={styles.Maindiv}>
      ...
      <div className={styles.Search}>
        ...
        />
        <span className={styles.Div3}>SEARCH RESULTS</span>
      </div>
      ...
      <div className={styles.Div4}>
        <div className={styles.Div5}>
          ...
          >{`${searchData.length} RESULTS FOR ${searchKey}`}</div>
        </div>
      </div>
      {searchData.length > 0 ? (
        <div className={styles.container}>
          ...
          <div className={styles.product_container}>
            <div>
              <h4>
                {searchData.length} results for{" "}
                <span style={{ color: "#C7007D", textTransform: "uppercase" }}>
                  {searchData.slice(0, 1).map((el) => {
                    return el.prod_name;
                  })}
                </span>
              </h4>
        ...
        <div style={{ width: "90%", margin: "auto" }}>
          <img style={{ width: "100%", margin: "auto" }} src="/notFound.JPG" />
        </div>
      )}
    </div>
  );
