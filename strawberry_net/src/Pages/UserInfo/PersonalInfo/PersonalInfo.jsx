...
export const PersonalInfo = () => {
  ...
  const handleOnChange = (e) => {
    setFormData({
      ...formData,
      ...User,
      ["avatar"]: imageurl !== null ? imageurl : User.avatar,
        ...
        <div className={styles.fullmainCont}>
          <div className={(classes.root, styles.mainCont)}>
            ...
            <Avatar
              ...
              alt="No image"
              src={imageurl ? imageurl : User ? User.avatar : ""}
            />
            ...
            <div className={styles.userCont}>
              ...
              >
                ...
                >
                  {User.birth_date !== "" && (
                    <option value={User.birth_date} selected>
                      {User.birth_date}
                    </option>
                  )}
                  {days.map((item, i) => (
                ...
                <label htmlFor="" style={{ width: "60px" }}>
                  Month
                </label>
                <select
                  name="birth_month"
                ...
                >
                  {User.birth_month && (
                    <option value={User.birth_month} selected>
                      {User.birth_month}
                    </option>
                  )}
                  {months.map((item) => (
            ...
            <div className={styles.userCont}>
              ...
              <div className={styles.inputCont}>
                ...
                >
                  {User.location && (
                    <option value={User.location} selected>
                      {User.location}
                    </option>
                  )}
                  {countries.map((item) => (
