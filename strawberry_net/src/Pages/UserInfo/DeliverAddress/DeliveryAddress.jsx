...
import styles from '../BillingAddress/BillingAddress.module.css';
                ...
                addresses.map((item, index) =>
                    <div key={index} className={styles.addressCont}>
                       ...
                       <div className={styles.linetwo}>
                           ...
                           <p style={{marginTop:'-30px'}}>{item.city}, {item.state}, {item.country}, {item.pincode} </p>
                           <p style={{marginTop:'-12px'}}>Tel. {item.countryCode} {item.phone}</p>
                       </div>
